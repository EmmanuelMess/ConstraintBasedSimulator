...
{
  try {
    CLI::App app{ fmt::format("{} version {}", ConstraintBasedSimulator::cmake::project_name, ConstraintBasedSimulator::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", ConstraintBasedSimulator::cmake::project_version);
      return EXIT_SUCCESS;
    }
